...
public class LoanLr {
    ...
    public LoanLr(Integer id, Double loan_amount, Integer term, Double installment, Double annual_income, Integer employment_length, Integer delinuency_2years, String application_type_cn, String issue_date, String is_default) {
        this.id = id;
